...
Train_data = pd.read_csv("data/train.txt", sep=" ") #You need to change : create a csv or tsv file of the required format; Assumed to have both train and validation data
...
model = Sequential()
model.add(Dense(16, input_dim=X_val.shape[1], activation="relu"))
